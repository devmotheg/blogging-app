...
const favoriteSchema = new mongoose.Schema({
  ...
  userId: referenceModel("favorite", { Model: User, name: "user" }, true),
  postId: referenceModel("favorite", { Model: Post, name: "post" }, true),
  createdAt: {
...
for (const [Model, refId] of [
  ...
  updateQuantity({
    updatedModel: Model,
    localSchema: favoriteSchema,
    updatedField: "favoritesQuantity",
    refId: refId,
  });
